...
# 1. Initialize a toatal vote counter.
total_votes = 0

# Creating new candidate list.
candidate_options = []
...
for candidate_name in candidate_votes:
    ...
    if (votes > winning_count) and (vote_percentage > winning_percentage):
        ...
        # And, set the winning _candidate equal to the candidate's name.
...
# To do: print our the winning candidate, vote count and percentage to terminal.
